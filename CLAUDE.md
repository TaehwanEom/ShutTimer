...
## 보존 문서 — 삭제된 기능 복원 레퍼런스 (절대 삭제 금지)

아래 문서는 v1.5 심사 대응으로 코드에서 제거된 자산의 원본을 보존.
재도입 시 이 문서의 "재도입 체크리스트" 절차 따를 것.

- docs/preserve/v15-location-removal.md — 위치 권한 제거 (14개 언어 번역 원문 포함)
  재도입 조건: 위치를 실제로 사용하는 기능 설계 + purpose string 구체 example 재작성
